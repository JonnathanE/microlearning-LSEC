					...
					<div className='col-4 col-md-1' onChange={onChangeValue}>
						<div className='form-check form-check-inline'>
							<input
								...
								name='gender'
							/>
							<label className='form-check-label h3' htmlFor='inlineRadio1'>
						...
						<div className='form-check form-check-inline'>
							<input
								...
								className='form-check-input'
								id='inlineRadio2'
								value={content.wrongAnswer}
								name='gender'
							/>
							<label className='form-check-label h3' htmlFor='inlineRadio2'>
								{content.wrongAnswer}
							</label>
						</div>
					</div>
