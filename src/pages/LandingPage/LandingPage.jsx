						...
						<div className='content mx-auto align-self-center px-4 my-5'>
							<div>
								<small className='d-block text-primary mb-3'>
									Ahora de aprender algo nuevo
								</small>
								<h1 className='display-4 fw-bold mb-4'>
									Aprende Lengua de Señas Ecuatoriana
								</h1>
								<p className='lead mb-4'>
									Aprender lengua de señas, da una nueva oportunidad
								</p>
						...
						<div className='col-lg-6'>
							<div className='align-self-center my-4 px-4'>
								<h1 className='display-4 fw-bold mb-5'>
									Construye un Ecuador Inclusivo
								</h1>
								<ul className='list-unstyled'>
									<li className='d-flex mb-4'>
										...
										<div className='ms-3'>
											<p className='lead fw-bold'>
												Crea tu cuenta<span className='text-primary'>.</span>
											</p>{' '}
											<p>
												Es muy sencillo, solamente ingresa tu correo electrónico
												y listo.
											</p>
										</div>
									</li>
									<li className='d-flex mb-4'>
										...
										<div className='ms-3'>
											...
											<p>
												Ingresa con tu cuenta y selecciona una lección que desea
												aprender.
											</p>
										</div>
									</li>
									<li className='d-flex mb-4'>
										...
										<div className='ms-3'>
											...
											<p>
												Puedes practicar por medio de preguntas de selección
												múltiple.
											</p>
										</div>
									</li>
					...
					<div className='row mb-3'>
						<div className='col-sm-6 col-lg-3 my-4'>
							...
							<ul className='list-unstyled'>
								<li className='mb-3'>
									<a
										href='https://github.com/JonnathanE/microlearning-LSEC'
								...
								<li>
									<a
										href='https://github.com/JonnathanE/api-microlearning-LSEC'
										className='text-dark text-decoration-none'
										target='_blank'
										rel='noreferrer'
									>
						...
						<div className='col-sm-6 col-lg-3 my-4'>
							...
							<ul className='list-unstyled'>
								<li className='mb-3'>
									<a
										href='https://github.com/JonnathanE'
										className='text-dark text-decoration-none'
										target='_blank'
										rel='noreferrer'
									>
						...
						<div className='col-sm-6 col-lg-3 my-4'>
							...
							<ul className='list-unstyled'>
								<li className='mb-3'>
									<a
										href='https://www.consejodiscapacidades.gob.ec/diccionario-de-lengua-de-senas-ecuatoriano-gabriel-roman/'
										className='text-dark text-decoration-none'
										target='_blank'
										rel='noreferrer'
									>
					...
					<div className='border-top py-4'>
						<div className='row'>
							<div className='col-md-12 col-lg-6'>
								<small>
									2021. Trabajo de Titulación. Todos los derechos reservados
								</small>
							</div>
							<div className='col-md-12 col-lg-6'>
